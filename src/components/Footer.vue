      ...
      <div
        ...
        <router-link
          ...
          <div
            ...
            <svg
              aria-hidden="true"
              class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 hover:-mt-1 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
              fill="currentColor"
              viewBox="0 0 20 20"
          ...
          <div
            class="flex items-center justify-center mt-1 text-grey-900 hover:no-underline font-medium rounded-lg dark:text-white dark:hover:bg-gray-700"
            aria-current="page">
            <p class="">Главная</p>
          </div>
        </router-link>
        ...
        <router-link
          ...
          <div
            class="flex items-center justify-center mt-1 text-grey-900 font-medium rounded-lg dark:text-white dark:hover:bg-gray-700"
            aria-current="page">
            <p class="whitespace-nowrap">Наши работы</p>
          </div>
        </router-link>
        <router-link
          to="/about"
          ...
          <div
            class="flex items-center justify-center mt-1 text-grey-900 font-medium rounded-lg dark:text-white dark:hover:bg-gray-700"
            aria-current="page">
            <p class="whitespace-nowrap">О нас</p>
          </div>
        </router-link>
        </div>
    </div>
